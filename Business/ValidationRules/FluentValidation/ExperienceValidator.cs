...
namespace Business.ValidationRules.FluentValidation
{
    public class ExperienceValidator : AbstractValidator<CreateExperienceRequest>
    {
        public ExperienceValidator()
        {
            ...
            RuleFor(e => e.Field).NotEmpty().WithMessage(BusinessMessages.RequiredField);
            RuleFor(e => e.Field).MinimumLength(5).WithMessage(BusinessMessages.MinLengthError5);
            RuleFor(e => e.Field).MaximumLength(50).WithMessage(BusinessMessages.MaxLengthError50);
