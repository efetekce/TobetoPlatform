...
namespace Business.ValidationRules.FluentValidation
{
    public class AccountExperienceValidator : AbstractValidator<CreateAccountExperienceRequest>
    {
        public AccountExperienceValidator()
        {
            ...
            RuleFor(e => e.Sector).NotEmpty().WithMessage("Doldurulması zorunlu alan!");
            RuleFor(e => e.Sector).MinimumLength(5).WithMessage("En az 5 karakter girmelisiniz!");
            RuleFor(e => e.Sector).MaximumLength(50).WithMessage("En fazla 50 karakter girebilirsiniz!");
