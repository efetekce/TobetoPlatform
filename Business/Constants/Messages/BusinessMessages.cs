...
namespace Business.Constants.Messages
{
    public class BusinessMessages
    {
        ...
        public static string SameDistrictNameError = "Aynı ilçeden birden fazla eklenemez!";
        ...
        public static string AccountSocialMediaLimit = "Max 3 sosyal medya eklenebilir!";
        public static string SameCountryCodeError = "Aynı ülke kodu tekrar eklenemez!";
        public static string SameSkillNameError = "Aynı yetenek tekrar eklenemez!";
    }
}
